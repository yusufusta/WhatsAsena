...
class Audio extends Base {
    ...
    _patch(data) {
        ...
        this.caption = data.message.audioMessage.caption === null ? data.message.audioMessage.caption : '';
        ...
        if (data.message.audioMessage.hasOwnProperty('contextInfo') && data.message.contextInfo.quotedMessage) { 

            this.reply_message = new ReplyMessage(this.client, data.message.audioMessage.contextInfo); }
